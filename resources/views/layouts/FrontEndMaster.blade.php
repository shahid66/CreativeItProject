                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="{{ url('/') }}"><img src="assets/images/logo/logo.png" alt="Site Logo" /></a>
                        </div>
                    </div>
                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        <div class="header-actions">
                            @auth('customerlogin')
                                    ...
                                    <ul>
                                      <li class="nav-item dropdown ">
                                        <a class=" nav-item dropdown-toggle " href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            {{ Auth::guard('customerlogin')->user()->name }}
                                        </a>
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                          <li><a class="dropdown-item" href="{{ route('customer.me',Auth::guard('customerlogin')->user()->id) }}">My Account</a></li>
                            ...
                            {{-- <a href="#" class="header-action-btn login-btn" >{{ Auth::guard('customerlogin')->user()->name }}</a> --}}

                            @else
                            <a href="{{ route('customer.register.view') }}" class="header-action-btn login-btn" >Sign In</a>
                            @endauth
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    ...
                    @foreach ( App\Models\Cart::where('user_id',Auth::guard('customerlogin')->id())->get() as $item)

                    <li>
                        <a href="{{ route('product.details',$item->rel_to_product->id) }}" class="image"><img src="{{ asset('uploads/products/preview') }}/{{ $item->rel_to_product->product_image }}"></a>
                        <div class="content">
                            <a href="{{ route('product.details',$item->rel_to_product->id) }}" class="title">{{ $item->rel_to_product->product_name }}</a>
                            <span class="quantity-price">{{ $item->quantity }}x <span class="amount">{{ $item->rel_to_product->discount_price }}</span></span>
                            <h6 style="font-size: 13px">Color: <span>{{ App\Models\color::where('id',$item->color_id)->first()->color_name  }}</span></h6>
                            <h6 style="font-size: 13px">Color: <span>{{App\Models\Size::where('id',$item->size_id)->first()->size_name  }}</span></h6>
                            <a href="{{ route('cart.delete', $item->id ) }}" class="remove">×</a>
                        </div>
                    </li>
                    @endforeach
                </ul>
            ...
            <div class="foot">
                <div class="buttons mt-30px">
                    <a href="{{ route('allCartItem') }}" class="btn btn-dark btn-hover-primary mb-30px">view cart</a>
